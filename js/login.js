window.addEventListener('load', function () {
    ...
    function getLoginData() {
        ...
        xhr.onload = function () {
            ...
            if (memNavInfo.memData.memberNo) {
                ...
                cartLink.removeEventListener('click', showLightbox);
                ...
                cartLink.addEventListener('click', showLightbox);
    ...
    function sendData() {
        ...
        xhr.onload = function () {
            if (xhr.status == 200) {
                // 是否已有該會員
                if (xhr.responseText.indexOf('無此會員') == -1) {
                    // 登入成功
